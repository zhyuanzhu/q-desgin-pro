    ...
    <transition :name="transition">
        <div :class="[`${prefixCls}`, `${prefixCls}-${type}`]" v-show="visible">
            <div :class="[`${prefixCls}-icon`, `icon-${type}`]">
                <svg class="icon" style="width: 1em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1911">

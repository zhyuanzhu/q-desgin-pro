            ...
            <tr v-for="(cols, rowIndex) in headRows">
                <th
                    ...
                    <div :class="cellClasses(column)">
                        ...
                        <template v-else>
                            ...
                            <span :class="[prefixCls + '-sort']" v-if="column.sortable">
                                <i class="qui-icon qui-icon-md-arrow-dropup" :class="{on: getColumn(rowIndex, index)._sortType === 'asc'}" @click="handleSort(getColumn(rowIndex, index)._index, 'asc')"></i>
                                <i class="qui-icon qui-icon-md-arrow-dropdown" :class="{on: getColumn(rowIndex, index)._sortType === 'desc'}" @click="handleSort(getColumn(rowIndex, index)._index, 'desc')"></i>
                            </span>
                            <Poptip
                                v-if="isPopperShow(column)"
                                v-model="getColumn(rowIndex, index)._filterVisible"
                                placement="bottom"
                                popper-class="qui-table-popper"
                                transfer
                                :capture="false"
                                @on-popper-hide="handleFilterHide(getColumn(rowIndex, index)._index)">
                                <span :class="[prefixCls + '-filter']">
                                    <i class="qui-icon qui-icon-ios-funnel" :class="{on: getColumn(rowIndex, index)._isFiltered}"></i>
                                </span>
                    ...
                    <div
                        ...
                        class="qui-table-header-resizable"
        ...
        methods: {
            ...
            handleMouseDown (column, event) {
                ...
                if (this.draggingColumn) {
                    ...
                    const columnEl = this.$el.querySelector(`th.qui-table-column-${column.__id}`);
